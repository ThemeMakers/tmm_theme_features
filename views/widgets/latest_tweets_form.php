...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('twitter_screen_name')); ?>"><?php esc_html_e('Twitter Screen Name', 'accio') ?>:</label>
...
<p>
    <label for="<?php echo esc_attr($widget->get_field_id('postcount')); ?>"><?php esc_html_e('Number of tweets', 'accio') ?>:</label>
