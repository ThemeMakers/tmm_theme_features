...
<div class="widget widget_custom_recent_entries">
				...
				<article class="entry">
					...
					<div class="post-holder">
						...
						<div class="entry-meta">
							...
							<span><a href="<?php the_permalink(); ?>#comments"><?php echo get_comments_number(); ?> <?php esc_html_e('Comments', 'accio'); ?></a></span>
						</div>
	...
	<?php if ($instance['show_see_all_button'] == "true"): ?>
		<?php if ($instance['category'] > 0): ?>
			<a class="button default small" href="<?php echo get_category_link((int) $instance['category']); ?>"><?php esc_html_e('See all posts', 'accio'); ?></a>
		<?php else: ?>
			<a class="button default small" href="<?php echo esc_js(home_url()) . '/' . date('Y') ?>"><?php esc_html_e('See all posts', 'accio'); ?></a>
		<?php endif; ?>
	<?php endif; ?>
