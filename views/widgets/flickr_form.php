...
<p>
    <label for="<?php echo esc_attr( $widget->get_field_id('username') ) ?>"><?php esc_html_e('Flickr Username', 'accio') ?>:</label>
...
<p>
    <label for="<?php echo esc_attr( $widget->get_field_id('imagescount') ) ?>"><?php esc_html_e('Number of images', 'accio') ?>:</label>
