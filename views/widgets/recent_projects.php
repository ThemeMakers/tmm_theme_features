			...
			<?php if ($query->have_posts()) : while ($query->have_posts()) : $query->the_post(); ?>
					...
					<li>
								...
								<div class="image-extra">
									<div class="extra-content">
										<div class="inner-extra">
											...
											<a href="<?php echo TMM_Helper::get_post_featured_image($post->ID, ''); ?>" data-gall="blog" class="single-image plus-icon"></a>
										</div><!--/ .inner-extra-->	
									</div><!--/ .extra-content-->
								</div><!--/ .image-extra-->	
							</div><!--/ .work-item-->	
						...
						<?php if ($instance['show_button']): ?>
							<a class="button default medium" href="<?php echo get_post_type_archive_link(TMM_Portfolio::$slug) ?>"><?php esc_html_e('See all projects', 'accio'); ?></a>
						<?php endif; ?>								
