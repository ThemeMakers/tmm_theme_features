...
<p>
    <label for="<?php echo esc_attr( $widget->get_field_id('phone') ) ?>"><?php esc_html_e('Phone', 'accio') ?>:</label>
...
<p>
    <label for="<?php echo esc_attr( $widget->get_field_id('email') ) ?>"><?php esc_html_e('E-Mail', 'accio') ?>:</label>
