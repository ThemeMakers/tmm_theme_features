...
<?php wp_dropdown_pages(array('id' => 'onepage_selector')); ?>&nbsp;<a href="#" id="onepage_add_page" class="button"><?php esc_html_e("Add Page", 'accio') ?></a>

<h2><?php esc_html_e("Pages", 'accio') ?></h2>
