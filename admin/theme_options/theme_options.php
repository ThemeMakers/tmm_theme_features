...
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_general/tab_general.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_styling/tab_styling.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_sliders/tab_sliders.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_blog/tab_blog.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_portfolio/tab_portfolio.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_contact_forms/tab_contact_forms.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_custom_sidebars/tab_custom_sidebars.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_api/tab_api.php';
include_once TMM_THEME_FEATURES_PATH . '/admin/theme_options/sections/tab_footer/tab_footer.php';
	...
	<section class="admin-container clearfix">
		...
		<section class="set-holder clearfix">
			...
			<div class="button-options">
				<a href="#" class="admin-button button-yellow button-options button_save_options"><?php esc_html_e('Save All Changes', 'accio'); ?></a>
				<a href="#" class="admin-button button-yellow button-options button_reset_options"><?php esc_html_e('Reset All Options', 'accio'); ?></a>
			</div><!--/ .button-options-->
		...
		<div class="framework-container clearfix">
			...
			<section id="options-framework" class="clearfix">
				...
				<div class="admin-group-button clearfix">
					<a class="admin-button button-yellow align-left button_reset_options" href="#"><?php esc_html_e('Reset All Options', 'accio'); ?></a>
					<a class="admin-button button-yellow align-right button_save_options" href="#"><?php esc_html_e('Save All Changes', 'accio'); ?></a>
				</div>
