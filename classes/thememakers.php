...
class TMM {
	...
	public static function change_options() {
		...
		switch ($action_type) {
			case 'save':
				...
				esc_html_e( 'Options have been updated.', 'accio' );
				break;
			...
			case 'reset':
				...
				esc_html_e( 'Options have been reset.', 'accio' );
				break;
	...
	public static function draw_widget_html($view, $data = array()) {
		@extract($data);
		ob_start();
		include(TMM_THEME_FEATURES_PATH . '/views/' . $view . '.php' );
		return ob_get_clean();
	}
